...
| 4 | `Des adresses près de la Kasbah ?` | Français | Met en avant les 4 adresses Kasbah/port (pulsation saffron) ✨ |
| 5 | `Un restaurant avec vue sur la mer ?` | Français | Active le tag **Vue mer** (5 adresses) et surligne les pins 🌊 |
| 6 | `Fin nakol l7out mzyan ?` | Darija | Recommande Saveur de Poisson **et** Marsa Fish, sélectionne le premier pin 🐟 |
| 7 | `Confirme ma réservation` | Français | Lance le tunnel de réservation en auto-confirmation → toast + « Mes réservations » 🎉 |
| 8 | `Ch7al 3andi dyal points ?` | Darija | Annonce le solde de points et ouvre l'espace fidélité 🏆 |
| 9 | `Choukran bzaf !` | Darija | Remerciement chaleureux en darija 🌿 |

Durée estimée : ~100 secondes — parfait pour la section assistant de la vidéo.
...
→ met en avant les restaurants de la Kasbah et du port (4 adresses)

### Poisson 🆕
- `Où manger du bon poisson ?`
- `Un bon poisson, des fruits de mer`
- `Fin nakol l7out mzyan ?`
→ recommande les 2 meilleures adresses poisson (Saveur de Poisson + Marsa Fish)
  et sélectionne la première sur la carte pendant la réponse

### Vue mer 🆕
- `Un restaurant avec vue sur la mer ?`
- `Chi blasa 3la lb7er ?`
→ active le filtre d'ambiance **Vue mer** (les pins correspondants pulsent sur la carte)
...
→ met en avant les adresses taguées « Romantique »
